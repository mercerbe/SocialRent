              ...
              <Table.Body>
                ...
                {this.state.ads.map((ad, i)=> (
                  ...
                  <Table.Row key={i} positive>
                    ...
                    <Table.Cell><Message>{ad.copy} <a href={'https://blooming-meadow-10170.herokuapp.com/'+ ad.mRoute} target='_blank' rel="noopener noreferrer">{'https://blooming-meadow-10170.herokuapp.com/'+ ad.mRoute}</a></Message></Table.Cell>
